  ...
  var TSNEOptimizer = (function () {
              ...
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                          ...
                          distParamTexture = createAndConfigureTexture(this.gpgpu.gl, shape.pointsPerRow, shape.numRows, 2);
      ...
      TSNEOptimizer.prototype.computeGaussianDistributions = function (distributions, distributionParameters, shape, knnGraph) {
          try {
              ...
              executeGaussiaDistributionsFromDistancesProgram(this.gpgpu, this.gaussiaDistributionsFromDistancesProgram, knnGraph, distributionParameters, shape.numPoints, shape.pixelsPerPoint, shape.pointsPerRow, shape.numRows, distTexture);
          }
          catch (e) {
              ...
              return __generator(this, function (_b) {
                  switch (_b.label) {
                      ...
                      case 1:
                          ...
                          this.knnEstimator = new KNNEstimator(this.packedData.texture, this.packedData.shape, this.numPoints, this.numDimensions, this.numNeighbors, this.verbose);
